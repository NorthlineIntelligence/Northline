...
export default function PriorityResultsPage() {
  ...
  async function load() {
    setLoading(true);
    setMessage(null);
    const res = await fetch(`/api/admin/priority-discovery/assessments/${assessmentId}/analysis`, { credentials: "include" });
    ...
    <div className="min-h-screen" style={{ background: shellBackground, color: BRAND.dark }}>
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div
          ...
          style={{ borderColor: BRAND.border, background: "#F9FAFB", color: BRAND.greyBlue }}
        >
        ...
        {loading ? (
          ...
          <div className="mt-8 rounded-2xl border bg-white p-6 shadow-sm" style={{ borderColor: BRAND.border }}>
            ...
            <p className="mt-2 text-sm" style={{ color: BRAND.greyBlue }}>Run the AI analysis after participants have submitted responses.</p>
          </div>
        ) : (
          <>
